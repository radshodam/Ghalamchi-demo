/**
 * @fileoverview App-wide 404 page.
 */
...
/**
 * Shown when the requested route does not exist.
 *
  ...
  return (
    <Container>
      <div className="flex min-h-[50vh] flex-col items-center justify-center rounded-3xl border border-paper-200 bg-white px-8 py-16 text-center shadow-lg">
        ...
        <p className="mt-3 max-w-md text-base leading-7 text-ink-600">
          آدرس واردشده معتبر نیست یا صفحه مورد نظر وجود ندارد.
        </p>
        <div className="mt-8">
          <Link
